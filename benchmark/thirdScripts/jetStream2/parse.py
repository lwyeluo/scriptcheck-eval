...
import os
import numpy as np
from benchmark.thirdScripts.jetStream2.globalDefinition import _CASES, _CASE_BASELINE, _CASE_OURS
...
class Parse(object):
    ...
    def __init__(self):
        ...
        self._feature = "DONE FOR RUNNING JetStream2. Score is "
    ...
    def parse(self):
        ...
        for case in _CASES:
            ...
            filepath = os.path.join(self._dir, "jetstream2_node_results_%s" % case)
...
def run():
    print("[JETSTREAM2] >>> parse the results")
    Parse().run()
